# Lorenzo 15/01/2019: identify.py modified to avoid bugs. 
# Please manually adjust the step size in the get_apoz function to avoid errors
# I set it to 100 by default
